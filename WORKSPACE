...
rules_scala_version="4c77c412e2c9316d468f8957984a63aa97ac149a" # update this as needed
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-clouddirectory:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_sagemakerruntime",
    artifact = "com.amazonaws:aws-java-sdk-sagemakerruntime:1.11.247",
)
...
maven_jar(
    name = "com_google_cloud_google_cloud_core_http",
    artifact = "com.google.cloud:google-cloud-core-http:1.10.0",
)
...
maven_jar(
    ...
    artifact = "io.aeron:aeron-client:1.3.0",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-marketplacemeteringservice:1.11.247",
)
...
maven_jar(
    name = "com_beachape_enumeratum_2_11",
    artifact = "com.beachape:enumeratum_2.11:1.5.12",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-acm:1.11.247",
)


maven_jar(
    name = "com_typesafe_play_play_functional_2_11",
    artifact = "com.typesafe.play:play-functional_2.11:2.6.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_emr",
    artifact = "com.amazonaws:aws-java-sdk-emr:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_logs",
    artifact = "com.amazonaws:aws-java-sdk-logs:1.11.247",
)
...
maven_jar(
    name = "com_netaporter_scala_uri_2_11",
    artifact = "com.netaporter:scala-uri_2.11:0.4.16",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_sns",
    artifact = "com.amazonaws:aws-java-sdk-sns:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-machinelearning:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-servermigration:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.agrona:agrona:0.9.6",
)


maven_jar(
    name = "org_scalaz_scalaz_core_2_11",
    artifact = "org.scalaz:scalaz-core_2.11:7.2.17",
)


maven_jar(
    name = "org_scalaz_scalaz_concurrent_2_11",
    artifact = "org.scalaz:scalaz-concurrent_2.11:7.2.17",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-codebuild:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_translate",
    artifact = "com.amazonaws:aws-java-sdk-translate:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_mediastoredata",
    artifact = "com.amazonaws:aws-java-sdk-mediastoredata:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.glassfish.jersey.core:jersey-common:2.23.1",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-cluster_2.11:2.5.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_route53",
    artifact = "com.amazonaws:aws-java-sdk-route53:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-ssm:1.11.247",
)
...
maven_jar(
    name = "com_github_docker_java_docker_java",
    artifact = "com.github.docker-java:docker-java:3.0.14",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cognitoidp",
    artifact = "com.amazonaws:aws-java-sdk-cognitoidp:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-messaging:4.3.13.RELEASE",
)


maven_jar(
    name = "org_springframework_spring_tx",
    artifact = "org.springframework:spring-tx:4.3.13.RELEASE",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_events",
    artifact = "com.amazonaws:aws-java-sdk-events:1.11.247",
)
...
maven_jar(
    name = "com_wixpress_jackson_jackson_scala_module",
    artifact = "com.wixpress.jackson:jackson-scala-module:2.8.8",
)


maven_jar(
    name = "org_springframework_spring_core",
    artifact = "org.springframework:spring-core:4.3.13.RELEASE",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_snowball",
    artifact = "com.amazonaws:aws-java-sdk-snowball:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.asynchttpclient:netty-codec-dns:2.0.37",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-migrationhub:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.fasterxml.jackson.jaxrs:jackson-jaxrs-json-provider:2.6.4",
)


maven_jar(
    name = "com_headius_unsafe_fences",
    artifact = "com.headius:unsafe-fences:1.0",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-lambda:1.11.247",
)
...
maven_jar(
    name = "com_wix_http_testkit_2_11",
    artifact = "com.wix:http-testkit_2.11:0.1.15",
)
...
maven_jar(
    ...
    artifact = "com.google.appengine:appengine-jsr107cache:1.9.59",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-polly:1.11.247",
)


maven_jar(
    name = "org_jsoup_jsoup",
    artifact = "org.jsoup:jsoup:1.11.2",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-lex:1.11.247",
)


maven_jar(
    name = "com_wix_http_testkit_core_2_11",
    artifact = "com.wix:http-testkit-core_2.11:0.1.15",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-cognitosync:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.zaxxer:HikariCP:2.7.4",
)
...
maven_jar(
    name = "io_spray_spray_json_2_11",
    artifact = "io.spray:spray-json_2.11:1.3.4",
)


maven_jar(
    name = "com_headius_modulator",
    artifact = "com.headius:modulator:1.0",
)


maven_jar(
    name = "com_typesafe_akka_akka_cluster_metrics_2_11",
    artifact = "com.typesafe.akka:akka-cluster-metrics_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-remote_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:2.6.4",
)
...
maven_jar(
    name = "org_joda_joda_money",
    artifact = "org.joda:joda-money:0.12",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_codepipeline",
    artifact = "com.amazonaws:aws-java-sdk-codepipeline:1.11.247",
)


maven_jar(
    name = "com_headius_invokebinder",
    artifact = "com.headius:invokebinder:1.10",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_gamelift",
    artifact = "com.amazonaws:aws-java-sdk-gamelift:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_models",
    artifact = "com.amazonaws:aws-java-sdk-models:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:play_2.11:2.6.7",
)
...
maven_jar(
    ...
    artifact = "org.asynchttpclient:async-http-client-netty-utils:2.0.37",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_comprehend",
    artifact = "com.amazonaws:aws-java-sdk-comprehend:1.11.247",
)


maven_jar(
    name = "net_sf_json_lib_json_lib_jdk15",
...
maven_jar(
    ...
    artifact = "com.google.api-client:google-api-client:1.19.1",
)
...
maven_jar(
    ...
    artifact = "io.reactivex:rxjava:1.3.3",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_efs",
    artifact = "com.amazonaws:aws-java-sdk-efs:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-opsworkscm:1.11.247",
)


maven_jar(
    name = "com_wix_accord_specs2_2_11",
    artifact = "com.wix:accord-specs2_2.11:0.6.1",
)


maven_jar(
    name = "org_asynchttpclient_netty_resolver",
    artifact = "org.asynchttpclient:netty-resolver:2.0.37",
)


maven_jar(
    name = "org_asynchttpclient_netty_resolver_dns",
    artifact = "org.asynchttpclient:netty-resolver-dns:2.0.37",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_stepfunctions",
    artifact = "com.amazonaws:aws-java-sdk-stepfunctions:1.11.247",
)


maven_jar(
    name = "com_github_jnr_jnr_posix",
    artifact = "com.github.jnr:jnr-posix:3.0.42",
)
...
maven_jar(
    name = "com_wix_http_testkit_specs2_2_11",
    artifact = "com.wix:http-testkit-specs2_2.11:0.1.15",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_datapipeline",
    artifact = "com.amazonaws:aws-java-sdk-datapipeline:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-simpleworkflow:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-mechanicalturkrequester:1.11.247",
)


maven_jar(
    name = "io_netty_netty_transport_native_kqueue_osx_x86_64",
    artifact = "io.netty:netty-transport-native-kqueue:jar:osx-x86_64:4.1.11.Final",
)
...
maven_jar(
    ...
    artifact = "org.iq80.leveldb:leveldb:0.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-config:1.11.247",
)
...
maven_jar(
    ...
    artifact = "net.databinder.dispatch:dispatch-json4s-jackson_2.11:0.12.3",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-support:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-dax:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-oxm:4.3.13.RELEASE",
)
...
maven_jar(
    ...
    artifact = "org.mozilla:rhino:1.7.7.2",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_pricing",
    artifact = "com.amazonaws:aws-java-sdk-pricing:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-elasticloadbalancingv2:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_mobile",
    artifact = "com.amazonaws:aws-java-sdk-mobile:1.11.247",
)


maven_jar(
    name = "com_typesafe_akka_akka_actor_2_11",
    artifact = "com.typesafe.akka:akka-actor_2.11:2.5.7",
)
...
maven_jar(
    name = "com_wix_accord_core_2_11",
    artifact = "com.wix:accord-core_2.11:0.6.1",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-rds:1.11.247",
)


maven_jar(
    name = "com_google_apis_google_api_services_calendar",
    artifact = "com.google.apis:google-api-services-calendar:v3-rev112-1.19.1",
)
...
maven_jar(
    name = "org_scijava_native_lib_loader",
    artifact = "org.scijava:native-lib-loader:2.0.2",
)
...
maven_jar(
    ...
    artifact = "org.jruby:jruby-stdlib:9.1.14.0",
)
...
maven_jar(
    name = "com_wixpress_specs2_jmock_2_11",
    artifact = "com.wixpress:specs2-jmock_2.11:0.1.16",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-web:4.3.13.RELEASE",
)


maven_jar(
    name = "org_iq80_leveldb_leveldb_api",
    artifact = "org.iq80.leveldb:leveldb-api:0.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_pinpoint",
    artifact = "com.amazonaws:aws-java-sdk-pinpoint:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_elasticloadbalancing",
    artifact = "com.amazonaws:aws-java-sdk-elasticloadbalancing:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-beans:4.3.13.RELEASE",
)
...
maven_jar(
    name = "com_wix_accord_spring3_2_11",
    artifact = "com.wix:accord-spring3_2.11:0.6.1",
)
...
maven_jar(
    ...
    artifact = "org.glassfish.jersey.bundles.repackaged:jersey-guava:2.23.1",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:play-iteratees_2.11:2.6.1",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-opsworks:1.11.247",
)


maven_jar(
    name = "org_springframework_spring_jms",
    artifact = "org.springframework:spring-jms:4.3.13.RELEASE",
)


maven_jar(
    name = "org_springframework_spring_jdbc",
    artifact = "org.springframework:spring-jdbc:4.3.13.RELEASE",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_ecr",
    artifact = "com.amazonaws:aws-java-sdk-ecr:1.11.247",
)


maven_jar(
    name = "org_jruby_jruby_core",
    artifact = "org.jruby:jruby-core:9.1.14.0",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_kinesis",
    artifact = "com.amazonaws:aws-java-sdk-kinesis:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-test:4.3.13.RELEASE",
)


maven_jar(
    name = "com_wix_http_testkit_server_2_11",
    artifact = "com.wix:http-testkit-server_2.11:0.1.15",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:jmespath-java:1.11.247",
)


maven_jar(
    name = "com_google_appengine_appengine_api_labs",
    artifact = "com.google.appengine:appengine-api-labs:1.9.59",
)
...
maven_jar(
    ...
    artifact = "com.github.jnr:jnr-netdb:1.1.6",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_servicediscovery",
    artifact = "com.amazonaws:aws-java-sdk-servicediscovery:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_mediaconvert",
    artifact = "com.amazonaws:aws-java-sdk-mediaconvert:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-marketplaceentitlement:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.bitbucket.b_c:jose4j:0.5.8",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-protobuf_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-applicationautoscaling:1.11.247",
)
...
maven_jar(
    name = "com_kohlschutter_junixsocket_junixsocket_native_common",
    artifact = "com.kohlschutter.junixsocket:junixsocket-native-common:2.0.4",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-codedeploy:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_medialive",
    artifact = "com.amazonaws:aws-java-sdk-medialive:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_iotjobsdataplane",
    artifact = "com.amazonaws:aws-java-sdk-iotjobsdataplane:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.google.http-client:google-http-client-appengine:1.23.0",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloudhsm",
    artifact = "com.amazonaws:aws-java-sdk-cloudhsm:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloudtrail",
    artifact = "com.amazonaws:aws-java-sdk-cloudtrail:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_kinesisvideo",
    artifact = "com.amazonaws:aws-java-sdk-kinesisvideo:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.google.maps:google-maps-services:0.2.5",
)
...
maven_jar(
    name = "com_kohlschutter_junixsocket_junixsocket_common",
    artifact = "com.kohlschutter.junixsocket:junixsocket-common:2.0.4",
)


maven_jar(
    name = "org_reactivemongo_reactivemongo_2_11",
    artifact = "org.reactivemongo:reactivemongo_2.11:0.12.7",
)


maven_jar(
    name = "com_google_cloud_datastore_datastore_v1_proto_client",
    artifact = "com.google.cloud.datastore:datastore-v1-proto-client:1.4.1",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-greengrass:1.11.247",
)


maven_jar(
    name = "org_glassfish_jersey_core_jersey_client",
    artifact = "org.glassfish.jersey.core:jersey-client:2.23.1",
)


maven_jar(
    name = "com_restfb_restfb",
    artifact = "com.restfb:restfb:1.49.0",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-iam:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.apache.logging.log4j:log4j-api:2.5",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-elasticbeanstalk:1.11.247",
)


maven_jar(
    name = "org_jruby_jruby",
    artifact = "org.jruby:jruby:9.1.14.0",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-xray:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.pcollections:pcollections:2.1.2",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-context:4.3.13.RELEASE",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-storagegateway:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_ec2",
    artifact = "com.amazonaws:aws-java-sdk-ec2:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_elasticache",
    artifact = "com.amazonaws:aws-java-sdk-elasticache:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-testkit_2.11:2.5.7",
)


maven_jar(
    name = "com_wix_specs2_jmock_2_11",
    artifact = "com.wix:specs2-jmock_2.11:1.2.0",
)
...
maven_jar(
    name = "org_reactivemongo_reactivemongo_shaded",
    artifact = "org.reactivemongo:reactivemongo-shaded:0.12.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloudhsmv2",
    artifact = "com.amazonaws:aws-java-sdk-cloudhsmv2:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_s3",
    artifact = "com.amazonaws:aws-java-sdk-s3:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-elastictranscoder:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-importexport:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_mq",
    artifact = "com.amazonaws:aws-java-sdk-mq:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.jruby.jcodings:jcodings:1.0.18",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:play-streams_2.11:2.6.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_glue",
    artifact = "com.amazonaws:aws-java-sdk-glue:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.google.appengine:appengine-api-1.0-sdk:1.9.59",
)


maven_jar(
    name = "org_jruby_extras_bytelist",
    artifact = "org.jruby.extras:bytelist:1.0.15",
)
...
maven_jar(
    ...
    artifact = "org.jruby.joni:joni:2.1.11",
)
...
maven_jar(
    name = "com_wix_accord_api_2_11",
    artifact = "com.wix:accord-api_2.11:0.6.1",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-ecs:1.11.247",
)


maven_jar(
    name = "org_apache_activemq_activemq_broker",
    artifact = "org.apache.activemq:activemq-broker:5.15.2",
)
...
maven_jar(
    ...
    artifact = "com.twilio.sdk:twilio:7.17.0",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_kms",
    artifact = "com.amazonaws:aws-java-sdk-kms:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-cloudformation:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.reactivemongo:reactivemongo-bson-macros_2.11:0.12.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_costandusagereport",
    artifact = "com.amazonaws:aws-java-sdk-costandusagereport:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_lexmodelbuilding",
    artifact = "com.amazonaws:aws-java-sdk-lexmodelbuilding:1.11.247",
)


maven_jar(
    name = "io_netty_netty_transport_native_epoll_linux_x86_64",
    artifact = "io.netty:netty-transport-native-epoll:jar:linux-x86_64:4.0.52.Final",
)


maven_jar(
    name = "org_apache_activemq_activemq_openwire_legacy",
    artifact = "org.apache.activemq:activemq-openwire-legacy:5.15.2",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-orm:4.3.13.RELEASE",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_discovery",
    artifact = "com.amazonaws:aws-java-sdk-discovery:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_mediastore",
    artifact = "com.amazonaws:aws-java-sdk-mediastore:1.11.247",
)


maven_jar(
    name = "com_wix_future_perfect_2_11",
    artifact = "com.wix:future-perfect_2.11:0.1.10",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cognitoidentity",
    artifact = "com.amazonaws:aws-java-sdk-cognitoidentity:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-core:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-slf4j_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-marketplacecommerceanalytics:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-lightsail:1.11.247",
)
...
maven_jar(
    name = "com_google_guava_guava_jdk5",
    artifact = "com.google.guava:guava-jdk5:13.0",
)


maven_jar(
    name = "com_github_jnr_jffi_native",
    artifact = "com.github.jnr:jffi:jar:native:1.2.16",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-api-gateway:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloudwatch",
    artifact = "com.amazonaws:aws-java-sdk-cloudwatch:1.11.247",
)


maven_jar(
    name = "org_scalaz_scalaz_effect_2_11",
    artifact = "org.scalaz:scalaz-effect_2.11:7.2.17",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_inspector",
    artifact = "com.amazonaws:aws-java-sdk-inspector:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.asynchttpclient:async-http-client:2.0.37",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-glacier:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:twirl-api_2.11:1.3.12",
)


maven_jar(
    name = "com_github_jnr_jnr_unixsocket",
    artifact = "com.github.jnr:jnr-unixsocket:0.17",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_resourcegroups",
    artifact = "com.amazonaws:aws-java-sdk-resourcegroups:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_simpledb",
    artifact = "com.amazonaws:aws-java-sdk-simpledb:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.codehaus.plexus:plexus-interpolation:1.1",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-waf:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-persistence_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-batch:1.11.247",
)


maven_jar(
    name = "io_netty_netty_transport_native_unix_common",
    artifact = "io.netty:netty-transport-native-unix-common:4.1.11.Final",
)
...
maven_jar(
    ...
    artifact = "com.sendgrid:sendgrid-java:4.1.2",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-expression:4.3.13.RELEASE",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-redshift:1.11.247",
)


maven_jar(
    name = "com_typesafe_play_play_json_2_11",
    artifact = "com.typesafe.play:play-json_2.11:2.6.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-codecommit:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-cloudfront:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-elasticsearch:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-resourcegroupstaggingapi:1.11.247",
)


maven_jar(
    name = "com_typesafe_akka_akka_cluster_tools_2_11",
    artifact = "com.typesafe.akka:akka-cluster-tools_2.11:2.5.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-sqs:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.apache.activemq:activemq-pool:5.15.2",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_serverlessapplicationrepository",
    artifact = "com.amazonaws:aws-java-sdk-serverlessapplicationrepository:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-workspaces:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-dms:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.google.cloud:google-cloud-datastore:1.10.0",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_shield",
    artifact = "com.amazonaws:aws-java-sdk-shield:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-autoscaling:1.11.247",
)
...
maven_jar(
    ...
    artifact = "org.springframework:spring-context-support:4.3.13.RELEASE",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:build-link:2.6.7",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-sts:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_devicefarm",
    artifact = "com.amazonaws:aws-java-sdk-devicefarm:1.11.247",
)


maven_jar(
    name = "com_wix_accord_scalatest_2_11",
    artifact = "com.wix:accord-scalatest_2.11:0.6.1",
)
...
maven_jar(
    ...
    artifact = "io.netty:netty-codec-http:4.0.52.Final",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloudsearch",
    artifact = "com.amazonaws:aws-java-sdk-cloudsearch:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:play-netty-utils:2.6.7",
)


maven_jar(
    name = "net_databinder_dispatch_dispatch_core_2_11",
    artifact = "net.databinder.dispatch:dispatch-core_2.11:0.12.3",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_athena",
    artifact = "com.amazonaws:aws-java-sdk-athena:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_sagemaker",
    artifact = "com.amazonaws:aws-java-sdk-sagemaker:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_alexaforbusiness",
    artifact = "com.amazonaws:aws-java-sdk-alexaforbusiness:1.11.247",
)


maven_jar(
    name = "com_googlecode_xmemcached_xmemcached",
    artifact = "com.googlecode.xmemcached:xmemcached:2.4.0",
)


maven_jar(
    name = "io_dropwizard_metrics_metrics_graphite",
    artifact = "io.dropwizard.metrics:metrics-graphite:3.2.5",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_guardduty",
    artifact = "com.amazonaws:aws-java-sdk-guardduty:1.11.247",
)


maven_jar(
    name = "org_apache_activemq_activemq_client",
    artifact = "org.apache.activemq:activemq-client:5.15.2",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-health:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-servicecatalog:1.11.247",
)


maven_jar(
    name = "com_natpryce_make_it_easy",
    artifact = "com.natpryce:make-it-easy:4.0.1",
)
...
maven_jar(
    ...
    artifact = "org.glassfish.jersey.connectors:jersey-apache-connector:2.23.1",
)
...
maven_jar(
    name = "com_wix_http_testkit_client_2_11",
    artifact = "com.wix:http-testkit-client_2.11:0.1.15",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_iot",
    artifact = "com.amazonaws:aws-java-sdk-iot:1.11.247",
)
...
maven_jar(
    name = "org_parboiled_parboiled_2_11",
    artifact = "org.parboiled:parboiled_2.11:2.1.2",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_rekognition",
    artifact = "com.amazonaws:aws-java-sdk-rekognition:1.11.247",
)


maven_jar(
    name = "org_apache_httpcomponents_httpcore",
    artifact = "org.apache.httpcomponents:httpcore:4.4.8",
)


maven_jar(
    name = "org_springframework_spring_webmvc",
    artifact = "org.springframework:spring-webmvc:4.3.13.RELEASE",
)


maven_jar(
    name = "com_googlecode_libphonenumber_libphonenumber",
    artifact = "com.googlecode.libphonenumber:libphonenumber:8.8.8",
)
...
maven_jar(
    name = "biz_paluch_redis_lettuce",
    artifact = "biz.paluch.redis:lettuce:4.4.2.Final",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-workdocs:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-codestar:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-cloudwatchmetrics:1.11.247",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_organizations",
    artifact = "com.amazonaws:aws-java-sdk-organizations:1.11.247",
)


maven_jar(
    name = "org_springframework_spring_aop",
    artifact = "org.springframework:spring-aop:4.3.13.RELEASE",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-dynamodb:1.11.247",
)


maven_jar(
    name = "org_reactivemongo_reactivemongo_bson_2_11",
    artifact = "org.reactivemongo:reactivemongo-bson_2.11:0.12.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_budgets",
    artifact = "com.amazonaws:aws-java-sdk-budgets:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-ses:1.11.247",
)


maven_jar(
    name = "io_aeron_aeron_driver",
    artifact = "io.aeron:aeron-driver:1.3.0",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_cloud9",
    artifact = "com.amazonaws:aws-java-sdk-cloud9:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.akka:akka-stream_2.11:2.5.7",
)
...
maven_jar(
    name = "com_beachape_enumeratum_macros_2_11",
    artifact = "com.beachape:enumeratum-macros_2.11:1.5.9",
)
...
maven_jar(
    ...
    artifact = "io.jsonwebtoken:jjwt:0.4",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_mediapackage",
    artifact = "com.amazonaws:aws-java-sdk-mediapackage:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.typesafe:ssl-config-core_2.11:0.2.2",
)
...
maven_jar(
    ...
    artifact = "com.typesafe.play:play-exceptions:2.6.7",
)


maven_jar(
    name = "com_amazonaws_aws_java_sdk_appstream",
    artifact = "com.amazonaws:aws-java-sdk-appstream:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-directory:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.google.appengine:appengine-endpoints:1.9.59",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_costexplorer",
    artifact = "com.amazonaws:aws-java-sdk-costexplorer:1.11.247",
)
...
maven_jar(
    name = "com_amazonaws_aws_java_sdk_appsync",
    artifact = "com.amazonaws:aws-java-sdk-appsync:1.11.247",
)
...
maven_jar(
    ...
    artifact = "com.amazonaws:aws-java-sdk-directconnect:1.11.247",
)


maven_jar(
    name = "org_apache_activemq_activemq_jms_pool",
    artifact = "org.apache.activemq:activemq-jms-pool:5.15.2",
)
